...
*/
	...
	try{ // Test pour l'exception ObjetNonPossedeParLeVivantException.
		...
		/* Après ces tests, le terminal doit retourner :
			Nom d'entité déjà utilisé dans le monde. 1
			Objet absent de la pièce. 2
			Objet non déplaçable. 3
			Objet non possédé par le vivant. 4
		*/
  }
}
